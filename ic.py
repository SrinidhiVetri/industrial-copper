...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r"C:\Users\SunLand\Desktop\New folder\industrial copper modeling\regression_model.pkl", 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r'C:\Users\SunLand\Desktop\New folder\industrial copper modeling\classification_model.pkl', 'rb') as f:
                model = pickle.load(f)
            # make array for all user input values in required order for model prediction
            user_data = np.array([[customer, 
                                country, 
